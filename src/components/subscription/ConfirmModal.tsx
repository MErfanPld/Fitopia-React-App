        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center">
            <svg className="w-6 h-6 text-primary" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20 2H4c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-3.5 9c0 1.93-1.57 3.5-3.5 3.5S9.5 12.93 9.5 11 11.07 7.5 13 7.5s3.5 1.57 3.5 3.5zm3.5 7H4v-2c0-2.14 3.56-3.5 9-3.5s9 1.36 9 3.5v2z" />
            </svg>
          </div>
          <div>
