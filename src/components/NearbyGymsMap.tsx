...
export function NearbyGymsMap() {
  ...
  return (
    <section className="mt-10 fade-in-up select-none" style={{ animationDelay: "0.5s" }} id="nearby-gyms-map">
      <h4 className="font-headline-md text-headline-md text-on-surface mb-4">باشگاه‌های نزدیک شما</h4>
      ...
      <div className="relative w-full h-64 rounded-2xl overflow-hidden glass-card border border-white/5">
        ...
        <div className="absolute inset-0 opacity-40 mix-blend-screen pointer-events-none">
          <img
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCuX1C6qgAjPxCfHBuJNDAzacUpAjRWdLIngiYO8Xa2-co32lpYoaGA8QN3V9xfkXSuM73TNg0U-Yn526KXr3KL2ojOJ4YVuDS11LifDcUmUKThEj0FMhLyQ01BvqSLaHVGcA_Gf3-4Mwc-PFoKjEhuI_2_oAmwNABKGTrYIpNtrbJJ7QjD0ugZsBRhoCejnqkdVSVwYExWa_5fJuKwT5vPVo5OPnBQy-9VxLVfbIev1VTskHo3anZcKakyQelhddghA7nVaXMr2DoT"
          />
        </div>
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
          <button
            ...
            className="whitespace-nowrap bg-surface/90 backdrop-blur-md px-6 py-2.5 rounded-full border border-primary/30 text-primary font-bold text-sm flex items-center gap-2 active:scale-95 transition-transform cursor-pointer hover:bg-surface"
          >
